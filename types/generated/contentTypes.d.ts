...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    aboutUs: Attribute.Blocks & Attribute.Required;
...
export interface ApiGeneralPageGeneralPage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::general-page.general-page', 'title'>;
    cover: Attribute.Media & Attribute.Required;
    seo: Attribute.Component<'seo.seo-information'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    servicesPreview: Attribute.Component<'layout.services-preview', true>;
...
export interface ApiPostPagePostPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    posts: Attribute.Relation<
      ...
      'api::post.post'
    >;
    slug: Attribute.UID<'api::post-page.post-page', 'title'> &
      Attribute.Required;
    seo: Attribute.Component<'seo.seo-information'>;
    excludedPosts: Attribute.Relation<
      'api::post-page.post-page',
      'oneToMany',
      'api::post.post'
    >;
